	...
	<?php include ( "./inc/header.inc.php" ); ?>
		<div style="width: 900px; margin: 52px auto;">
			...
			<div style="float: right;">
				 <div class="notificationbox">
				 	</a><a href="notifications.php"><h2 style="float: left; color: #848684;">Buddies Notification&nbsp;</h2></a><a href="notification.php"><h2  style="float: left; color: darkblue;">|&nbsp;Post Notification</h2>
		...
		if ($pro_changed_db != $profile_pic_db) {
			...
			$profile_pic = "userdata/profile_pics/".$profile_pic_db;
											...
											$get_descrip = mysqli_query($con,"SELECT * FROM posts WHERE id='$post_id'");
											...
											echo "<div style='margin: 10px; padding: 7px 0px;'>";
												...
												echo "<div style='margin: 0 0 0 50px; line-height: 1.4;'>";
													echo "<b><a href='profile.php?u=$user_by' style='text-decoration: none; font-size: 14px; color: darkblue;'  class='posted_by'>$posted_by</a></b><span style='font-size: 15px; margin-left: 10px;'>".$comment_disp."</span>
													"; 
														 if ($discription == "") {
														 	//
														 }else {
