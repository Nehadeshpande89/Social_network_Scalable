			...
			if ($num == 1) {
				...
				<div id="top">
					...
					if (($msg_count >=1 ) || ($username == $user)){
						...
						$getposts = mysqli_query($con,"SELECT * FROM posts WHERE user_posted_to ='$username' AND note='0' AND daowat_give='0' AND report='0' ORDER BY id DESC LIMIT 10") or die(mysqli_error());
