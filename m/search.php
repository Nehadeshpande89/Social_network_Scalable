		...
		<?php
			if (($_GET['keywords'] && $_GET['topic']) != NULL) {
				...
				if (isset($_GET['keywords'])) {
					...
					$query = mysqli_query($con,$query) or die ("could not count");
					...
					echo '<div style="padding: 10px;"><div class="search_banner">Result for: 
						...
						while ($row=mysqli_fetch_array($query)) {
							...
							<div style=' padding: 8px 0; min-height: 80px;'> ";
								...
								echo "<div style='margin-left: 74px; line-height: 18px; font-size: 14px;'><b><a href='profile.php?u=".$username."' style='text-decoration: none; font-size: 14px; color: darkblue;' title=\"Go to ".$first_name."'s Profile\" class='posted_by'>".$first_name."</a></b> <br>";
								if ($user == $username) {
									echo '<div class="">
