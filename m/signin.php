			...
			if ($check == 0 ) {
				if ($email_check == 0) {
					if (strlen($_POST['password']) >4 ) {
						...
						$result = mysqli_query($con,"INSERT INTO users (first_name,username,email,password,gender,sign_up_date,confirmCode) VALUES ('$_POST[first_name]','$_POST[username]','$_POST[email]','$_POST[password]','$_POST[gender]','$d','$confirmCode')");
						...
						$msgdate = date("Y-m-d");
						$opened = "no";
						$messagesuser = mysqli_query($con,"INSERT INTO pvt_messages VALUES ('','$user_to','$user_from','$msg_body','$msgdate','NOW()', '$opened','')");
