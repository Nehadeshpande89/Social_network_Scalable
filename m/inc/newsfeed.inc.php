<?php
	...
	if($sharepostid != 0) {
		...
		if($sp_added_by == $added_by) {
			if ($gender_user_db == '1') {
				$discription = "shared his <a href='viewPost.php?pid=".$sharepostid."' style='text-decoration: none; color: darkblue;'>".$post_item."</a>";
			...
			$discription = "shared ".$sp_add_by."'s <a href='viewPost.php?pid=".$sharepostid."' style='text-decoration: none; color: darkblue;'>".$post_item."</a>";
		}
	}
	...
	//showing data on profile
			...
			echo "<div class='posted_body'><div class='posted_date'>$date_added</div><p style='word-break: break-all;'>".nl2br($body)."</p>";
				...
				if ($rows_uname == 1) {
					echo "<a href='like.php?upid=".$id."' style='color: darkblue; margin-left: 10px;' >Liked . </a>";
					echo "<a href='plikesppl.php?plikep=".$id."' style='color: darkblue;' >$count_like people</a>";
				}else {
