<?php
	...
	if (strlen($body) > 5000) {
			$body = substr($body, 0, 5000)." <a href='viewPost.php?pid=".$id."' style='text-decoration: none; color: darkblue;'> ...read more</a>";
		}else
			$body = $body;
	...
	//showing data on profile
			...
			if ($user_posted_to == $added_by) {
				...
				$note_check =  mysqli_query($con,"SELECT * FROM posts WHERE id='$id'");
