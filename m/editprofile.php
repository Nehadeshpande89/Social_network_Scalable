...
$get_info = mysqli_query($con,"SELECT company, position, school, concentration FROM users WHERE username='$user'");
...
if ($updateinfo) {
	...
	$info_submit_query = mysqli_query($con,"UPDATE users SET company='$company', position='$position' WHERE username='$user'");
	...
	//submit the form to database
	$info_submit_query = mysqli_query($con,"UPDATE users SET school='$school', concentration='$concentration' WHERE username='$user'");
...
//email and  mobile
//Update Bio and first name last name query
$get_info = mysqli_query($con,"SELECT mobile,pub_email,email FROM users WHERE username='$user'");
$get_row = mysqli_fetch_assoc($get_info);
...
if ($sendeditcontact) {
	...
	$pub_email = mysqli_real_escape_string($con,$pub_email);
	//submit the form to database
	$info_submit_query = mysqli_query($con,"UPDATE users SET mobile='$mobile',pub_email='$pub_email' WHERE username='$user'");
	header("Location: about.php?u=".$user."");
	}
...
//Update Bio and first name last name query
$get_info = mysqli_query($con,"SELECT country,city,hometown FROM users WHERE username='$user'");
$get_row = mysqli_fetch_assoc($get_info);
...
if ($sendeditlocation) {
	...
	//submit the form to database
	$info_submit_query = mysqli_query($con,"UPDATE users SET city='$city' WHERE username='$user'");
	$info_submit_query = mysqli_query($con,"UPDATE users SET country='$country' WHERE username='$user'");
	$info_submit_query = mysqli_query($con,"UPDATE users SET hometown='$hometown' WHERE username='$user'");
	header("Location: about.php?u=".$user."");
	}
?>
...
$update = @$_POST['update'];
//Update Bio and first name last name query
$get_info = mysqli_query($con,"SELECT bio,queote FROM users WHERE username='$user'");
$get_row = mysqli_fetch_assoc($get_info);
$db_bio = $get_row['bio'];
...
if ($updatebio) {
	...
	//submit the form to database
	$info_submit_query = mysqli_query($con,"UPDATE users SET bio='$bio' WHERE username='$user'");
...
if ($update) {
	$queote = $_POST['queote'];
	$queote = trim($queote);
	$queote = mysqli_real_escape_string($con,$queote);
	//submit the form to database
	$info_submit_query = mysqli_query($con,"UPDATE users SET queote='$queote' WHERE username='$user'");
