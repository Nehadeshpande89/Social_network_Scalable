...
if (!isset($_SESSION['user_login'])) {
 ...
 if ($newsfeedlastid >= 1) {
		...
		$getposts = mysqli_query($con,"SELECT * FROM posts WHERE newsfeedshow ='1' AND report ='0' AND daowat_give ='0' AND note='0' AND id < $newsfeedlastid ORDER BY id DESC") or die(mysqli_error());
