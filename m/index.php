	...
	<div class="pro_body">
		<div class="pro_header">
			<nav class="pro_hdr_menu">
				<ul>
					...
					<li ><a href="index.php" style="color: #2AED25; font-weight: bold;">Buddies</a></li>	
		...
		<div class="post_field">
				<div class="profilePosts">
					<div class="postForm">
						<form action="" method="POST">
							...
							<div style="float: right;">
								<input type="submit" name="newDaowat" value="New Buddies" class="postSubmit" >
							</div>
					...
					$lastid = "";
					$getposts = mysqli_query($con,"SELECT * FROM posts WHERE daowat_give != '0' ORDER BY id DESC LIMIT 10") or die(mysqli_error());
