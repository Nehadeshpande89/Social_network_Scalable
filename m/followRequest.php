		 		...
		 		<ul>
		 			<li style='line-height: 15px;'>
		 				<?php 
							...
							$get_followR = mysqli_query($con,"SELECT * FROM follow WHERE user_to ='$user' ORDER BY id DESC LIMIT 50");
					...
					if ($pro_changed_db != $profile_pic_db) {
						...
						$profile_pic = "".$folder_link."userdata/profile_pics/".$profile_pic_db;
										...
										echo "<div style='margin: 0 0 0 50px;'>";
											echo "<b><a href='profile.php?u=$user_from' style='text-decoration: none; font-size: 15px; color: darkblue;'  class='posted_by'>$user_from_fname</a></b><span style='font-size: 15px; margin-left: 10px;'>".$comment_disp."</span>
											"; 
