...
//read all message
$setopened_query = mysqli_query($con,"UPDATE pvt_messages SET opened='yes' WHERE user_to='$user'");
...
<div class="pro_body">
	<div class="pro_header">
		<nav class="pro_hdr_menu">
			<ul>
				<li><a href="index.php">Buddies</a></li>
				...
				*/
				...
				if (strlen($msg_body) > 300) {
					...
					if ($user_from == $user) {
						...
						echo "<div><b style='font-size: 14px; font-weight: bold; color: darkblue;'>$msg_to_fname</b> <br>
						...
						echo "<div><b style='font-size: 14px; font-weight: bold; color: darkblue;'>$msg_by_fname</b> <br>
