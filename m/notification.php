...
$pstopened_query = mysqli_query($con,"UPDATE post_comments SET opened='yes' WHERE posted_to='$user'");
						...
						$profile_pic = "".$folder_link."userdata/profile_pics/".$profile_pic_db;
									...
									echo "<a href='viewPost.php?pid=".$post_id."'><div style='margin: 10px; padding: 0px 0px; border-bottom: 1px solid #CDCDCD;'>";
										...
										echo "<div style='margin: 0 0 0 50px;'>";
											echo "<b style='text-decoration: none; font-size: 14px; color: darkblue;'  class='posted_by'>$posted_by</b><span style='font-size: 15px; margin-left: 10px;'>".$comment_disp."</span>
											"; 
											echo "<br>";
