						...
						if (mysqli_num_rows($check)===1) {
							...
							if ($username != $user) {
								if (isset($_POST['submit'])) { 
									...
									$messages = mysqli_query($con,"INSERT INTO pvt_messages VALUES ('','$user','$username','$msg_body','$date','','$opened','$getid')");
			...
			$profile_pic = "userdata/profile_pics/".$profile_pic_db;
										...
										<div style='margin: 10px;'>
											...
											<div style='margin: 0 0 0 50px;'>
												<b><a href='profile.php?u=$user_by' style='text-decoration: none; font-size: 14px; color: darkblue; font-weight: 700;' title=\"Go to $posted_by's Profile\" >$posted_by</a></b>
