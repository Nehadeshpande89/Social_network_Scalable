		...
		<article>
			...
			<?php echo '<li style="float: right;">
					...
					<div >
						...
						<li><a href="photo.php?u='.$username.'" style="background-color: #cdcdcd; color: darkblue">Photo</a></li>
			...
			<div style="max-width: 920px; margin: 0 auto;">
				...
				<div style="">
					<?php 
						...
						$getposts = mysqli_query($con,"SELECT * FROM posts WHERE user_posted_to ='$username' AND note='0' ORDER BY id DESC ") or die(mysqli_error());
