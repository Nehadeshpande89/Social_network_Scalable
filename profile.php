	...
	if ($num == 1) {
			...
			echo '<li style="float: right;">
							...
							<div >
								...
								<li><a href="profile.php?u='.$username.'" style="background-color: #cdcdcd; color: darkblue">Post</a></li>
								</ul>
								</nav>
							</div>
		...
		<div id="top">
			...
			if (($msg_count >=1 ) || ($username == $user)){
				...
				$getposts = mysqli_query($con,"SELECT * FROM posts WHERE user_posted_to ='$username' AND daowat_give='0' AND note='0' AND report='0' ORDER BY id DESC LIMIT 9") or die(mysqli_error());
