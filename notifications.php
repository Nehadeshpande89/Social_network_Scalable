	...
	<?php include ( "./inc/header.inc.php" ); ?>
		<div style="width: 900px; margin: 52px auto;">
				...
				<div class="homeLeftSideContent">
					<div class="home_cov" style= "background: url(<?php echo $cover_pic; ?>) repeat center center;">
						...
						<div class="homenavemanu">
							<div >
								<div ><a href="index.php">Buddies</a></div>
			...
			<div style="float: right;">
				 <div class="notificationbox">
				 	<a href="notifications.php"><h2 style="float: left; color: darkblue;">Buddies Notification&nbsp;|</h2></a><a href="notification.php"><h2 style="float: left;color: #848684;">&nbsp;Post Notification</h2></a>
				 	<div style='max-height: 500px; overflow: auto; width: 556px;'>
				 		<ul>
				 			<li style='line-height: 8px;'>
				 				<?php 
				 					//getting post comment
									$get_notipost = mysqli_query($con,"SELECT * FROM post_comments WHERE posted_to='$user' AND posted_by != '$user' ORDER BY id DESC LIMIT 50");
									$count_notipost = mysqli_num_rows($get_notipost);
								
				 					//getting daowat comment
									$get_notidwt = mysqli_query($con,"SELECT * FROM daowat_comments WHERE daowat_to='$user' AND daowat_by != '$user' ORDER BY id DESC LIMIT 50");
		...
		if ($pro_changed_db != $profile_pic_db) {
			...
			$profile_pic = "userdata/profile_pics/".$profile_pic_db;
											...
											$get_descrip = mysqli_query($con,"SELECT * FROM daowat WHERE id='$daowat_id'");
											...
											echo "<div style='margin: 10px; padding: 7px 0px;'>";
												...
												echo "<div style='margin: 0 0 0 50px; line-height: 1.4;'>";
													echo "<b><a href='profile.php?u=$user_by' style='text-decoration: none; font-size: 14px; color: darkblue;' title=\"Go to $posted_by's Profile\" class='posted_by'>$posted_by</a></b><span style='font-size: 15px; margin-left: 10px;'>".$comment_disp."</span>
													"; 
														 if ($discription == "") {
														 	//
														 }else {
