...
<table>
	<tbody>
					...
					<div class="home_cov" style= "background: url(<?php echo $cover_pic; ?>) repeat center center;">
						...
						<div class="homenavemanu">
							<div >
								...
								<div ><a href="newsfeed.php" style="color: darkblue">Newsfeed</a></div>
		...
		$getposts = mysqli_query($con,"SELECT * FROM posts WHERE newsfeedshow ='1' AND report ='0' AND note='0' AND daowat_give='0' ORDER BY id DESC") or die(mysqli_error());
