...
$get_info = mysqli_query($con,"SELECT first_name,nick_name FROM users WHERE username='$user'");
...
if ($updateinfo) {
	...
	if(strlen($firstname) < 7 || strlen($firstname) > 20 )  {
		...
		$info_submit_query = mysqli_query($con,"UPDATE users SET first_name='$firstname' WHERE username='$user'");
		...
		<li style="float: left;">
			...
			<div class="settingsleftcontent">
				<ul>
					...
					<li><a href="account_update.php" style="background-color: darkblue; border-radius: 3px; color: #fff;">Account</a></li>
			...
			<div class="settingsleftcontent">
				<p style="text-align: center; padding: 10px 0px;">Neha Deshpande &copy; 2021 | Buddies</p>
			</div>
		</li>
