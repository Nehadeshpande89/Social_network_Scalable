...
<div class="main"><table class="adminHeader">
	...
	<table class="adminmenu">
		<tr>
			...
			<th style="background-color: darkblue;"><a href="posts.php"><h1>Post</h1></a></th>
			<th><a href="daowat.php"><h1>Buddies</h1></a></th>
	...
	<div class="rightsidemenu">
		...
		//for getting post
		$getposts = mysqli_query($con,"SELECT * FROM daowat WHERE id ='$dwtpostid'") or die(mysqli_error());
