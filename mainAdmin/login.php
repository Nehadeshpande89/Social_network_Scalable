<?php 
	...
	if (isset($_POST['login'])) {
		if (isset($_POST['admin_user']) && isset($_POST['admin_pass'])) {
			...
			$result = mysqli_query($con,"SELECT * FROM admin_login WHERE user_name='$admin_user' AND user_pass='$admin_pass'");
...
<form method="POST" action="login.php" style="padding: 84px 15px;">
	<table class="admintable" width="450px" border="10" align="center" bgcolor="#FFFFFF" style="margin: 0 auto;">
		<tr>
