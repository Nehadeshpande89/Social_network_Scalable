...
<html>
<head>
	<title><?php echo $title_fname; ?> Buddies</title>
...
<body>
	...
	echo '<li style="float: right;">
					...
					<div >
						<nav>
						<ul>
						<li><a href="daowat.php?u='.$username.'">Buddies</a></li>
						...
						<li><a href="about.php?u='.$username.'" style="background-color: #cdcdcd; color: darkblue">About</a></li>
	...
	echo '<div class="uiaccountstyle" style="text-align: left; height: auto; width: 507px; padding: 25px; margin: 15px auto;">
		<div>
			<p style="font-size: 13px; font-weight: bold; color: #959695;">WORK AND EDUCATION';
				if ($user==$username) {
					echo '<a href="workedu_update.php" style="float: right; text-decoration: none; font-size: 12px; color: darkblue">Edit</a>';	
				}else {
			...
			<hr style="background-color: #ddd;">';
					...
					echo '
					<p style="font-size: 15px; margin-left: 25px; font-weight: bold; color: darkblue;">'.$user_company.'<br></p>
			<p style=" font-weight: bold; margin-left: 25px; ">'.$user_position.'<br></p></br>
			<p style="font-size: 15px; margin-left: 25px; font-weight: bold; color: darkblue;">'.$school_name_user.'<br></p>
		...
		<div>
				...
				if ($user==$username) {
					echo '<a href="cbinfo_update.php" style="float: right; text-decoration: none; font-size: 12px; color: darkblue">Edit</a>';	
				}else {
					
				}
		echo '</p>
			<hr style="background-color: #ddd;">
			<p style="font-size: 15px; margin-left: 25px; font-weight: bold; color: darkblue;">'.$user_mobile.'</p>
			<p style=" font-weight: bold; margin-left: 25px; ">Mobile</P><br>
			<p style="font-size: 15px; margin-left: 25px; font-weight: bold; color: darkblue;">'.$user_pub_email.'</p>
		...
		<div>
				...
				if ($user==$username) {
					echo '<a href="location_update.php" style="float: right; text-decoration: none; font-size: 12px; color: darkblue">Edit</a>';	
				}else {
		...
		echo '</p>
			<hr style="background-color: #ddd;">
			<p style="font-size: 15px; margin-left: 25px; font-weight: bold; color: darkblue;">'.$city_name_user.'</p>
			<p style=" font-weight: bold; margin-left: 25px; ">Current City</P><br>
			<p style="font-size: 15px; margin-left: 25px; font-weight: bold; color: darkblue;">'.$hometown_name_user.'</p>
		...
		<br><p style="font-size: 13px; font-weight: bold; color: #959695;">DETAILS ABOUT';
				if ($user==$username) {
					echo '<a href="details_update.php" style="float: right; text-decoration: none; font-size: 12px; color: darkblue">Edit</a>';	
				}else {
					
				}
		echo '</p>
			<hr style="background-color: #ddd;">
			<p style=" color: darkblue; margin-left: 25px; font-size: 14px; line-height: 18px; "> '.nl2br($user_bio).'<br></p>
		...
		echo '</p>
			<hr style="background-color: #ddd;">
			<p style=" color: darkblue; margin-left: 25px; font-size: 14px; line-height: 18px; ">'.nl2br($user_queote).'<br></p>
		</div>
	</div>';
	}else {
	echo '<section id="googleMap" style="height:500px">
	<iframe src="https://maps.google.com/maps?q=dublin&t=&z=13&ie=UTF8&iwloc=&output=embed" width="100%" height="auto !important" frameborder="0" style="border:10px;padding:10px" ></iframe>
	</section>';
	}
}else {
