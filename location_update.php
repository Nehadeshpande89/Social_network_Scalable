...
<?php echo $error; ?>
		...
		<li style="float: left;">
			<div class="settingsleftcontent">
				<ul>
					...
					<li><a href="location_update.php" style=" background-color: darkblue; border-radius: 4px; color: #fff;">Location and Places</a></li>
   ...
   <section id="googleMap" style="height:500px">
